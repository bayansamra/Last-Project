...
import Technology from "./../ListSkills";
import LocationOnOutlinedIcon from "@mui/icons-material/LocationOnTwoTone";
import {Cardjob,JobDescription,Jobdetail,Jobdetail2,SeeMore,ToggleSaveBtn,} from "./style";
import { useWorkContext } from "./../../context/WorkContext";

const CardJob = ({ Jobdetails }) => {
  ...
  useEffect(() => {
    localStorage.setItem("savedJobs", JSON.stringify(state.works));
    localStorage.setItem("count", state.count);
  }, [state.works, state.count]);
            ...
            <Jobdetail2>
              ...
              <span>
                ...
                <LocationOnOutlinedIcon
                  sx={{  width: "25px",verticalAlign: "middle" }}
                />
