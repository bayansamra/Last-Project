...
import {Jobtitle,Jobspeciality,JobDetailCard,Span,Jobdescription,Right,Left,JobStatus,Div,Btns,AboutClient,} from "./style";
import Technology from "../../../components/CardJop/Skills";
import SaveJobBtn from "./SaveJopBtn";
import PaymentMethod from "./PaymentMethod";

const DetailsJobCard = (props) => {
  return (
    <JobDetailCard >
      <Right>
        <Jobtitle>{props.detail.title}</Jobtitle>
        <Jobspeciality>{props.detail.speciality}</Jobspeciality>
        <Span>Posted {props.detail.posted}</Span>
        <Span>
          {" "}
          <svg
        ...
        <Jobdescription>{props.detail.description}</Jobdescription>
          ...
          <div>
            <p>
              <svg
                ...
                role="img"
              >
                <path d="M8.971 1.332H5.64V0h3.331v1.332zm4.33 6.675a5.995 5.995 0 01-11.991 0c0-1.432.504-2.747 1.347-3.778l-.544-.542-.471.471L.7 3.216l.47-.471.942-.941.47-.472.942.943-.471.47.553.552a5.97 5.97 0 013.7-1.283 5.996 5.996 0 015.995 5.993zm-2.397-.601H7.906V4.411H6.704v4.194h4.201V7.406z"></path>
              </svg>
              {props.detail.hourlyRate}
            </p>
            <p>Hourly</p>
          </div>
        </JobStatus>
        ...
        <Div>
          ...
          <Technology technologiesOfItem={props.detail?.technologies} />
        </Div>
      </Right>
      <Left>
        <Btns>
          ...
          <SaveJobBtn detail={props.detail} />
        </Btns>
        <Divider variant="fullWidth" />
        <Div>
        ...
        <AboutClient>
          ...
          <PaymentMethod detail={props.detail} />
          <p>Location: {props.detail.location}</p>
        </AboutClient>
      </Left>
    </JobDetailCard>
  );
