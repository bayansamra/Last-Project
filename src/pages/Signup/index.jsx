...
import {AlredyAccount,ErrorMessage,InputWrapper,Register,ShowPassword,StyledButton,StyledForm,StyledImg,StyledLink,StyledOR,SubmitButton,} from "../Login/style";
...
const Signup = () => {
  const {
    setAuthorized,loading,setLoading,
    errors,setErrors,setToken,
    setUsername,
  } = useAuthContext();
